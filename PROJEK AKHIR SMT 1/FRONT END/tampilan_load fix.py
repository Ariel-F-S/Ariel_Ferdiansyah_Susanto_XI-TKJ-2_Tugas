...
class aplikasidekstop:
    def __init__(self,root):
        ...
        self.logo = PhotoImage(file="C:/Users/ASUS/Documents/BENGKEL TKJ KLS 11/PEMROGRAMAN/Ariel_Ferdiansyah_Susanto_XI-TKJ-2_Tugas/PROJEK AKHIR SMT 1/FRONT END/1.png")
